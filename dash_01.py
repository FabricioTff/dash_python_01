    ...
    dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    html.H5("Cidades"),
                     dcc.Checklist(options= df_data["City"].value_counts().index,
                    value = df_data["City"].value_counts().index,
                    id= "check_city",
                    inline= True,
                    inputStyle= {"margin-right":"5px", "margin-left":"20px"}),
                
                    html.H5("Váriavel de análise", style={"margin-top": "30px"}),
                    dcc.RadioItems(["gross income", "Rating"], "gross income", id= "main_variable", inline= False,inputStyle= {"margin-right":"5px", "margin-left":"20px"})      
                ], style={"height": "90vh", "margin":20, "padding":"20px"})                     
            ], sm = 2),
